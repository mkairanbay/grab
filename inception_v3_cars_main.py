...
if __name__ == '__main__':
    ...
    for i in range(scores.shape[0]):
        ...
        print("Top-5 predicted classes", top5_res)
        print("Corresponding confidence scores", scores[i][best_5[0]],
              scores[i][best_5[1]], scores[i][best_5[1]], scores[i][best_5[3]], scores[i][best_5[4]])
